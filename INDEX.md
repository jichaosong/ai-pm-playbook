...
| 文件 | 核心内容 | 页数 | 适用场景 |
|------|---------|:----:|---------|
| [`AI产品经理研究与分析`](./docs/guide/research/ai-pm-research-roadmap.md) | 10 个研究方向地图、3 个 P0 项目计划 | 412 行 | 确定研究优先级 |
| [`大模型与 Harness 的未来轨迹`](./docs/guide/research/llm-harness-future-trajectory.md) | 三层 harness 分类、BigModel vs BigHarness 裁决 | 213 行 | 理解 agent 运行时趋势 |
| [`Harness Engineering 入门`](./docs/guide/research/harness-engineering-introduction.md) | Harness 六大组件、OpenAI Codex 案例、落地三步法 | ~200 行 | 全面理解 Harness Engineering 范式 |
...
| 你在做什么 | 推荐阅读 |
|-----------|---------|
| **要理解 Harness Engineering 范式** | 本文 → 大模型与 Harness 的未来轨迹 → Agent 循环 → 可观测性 |
