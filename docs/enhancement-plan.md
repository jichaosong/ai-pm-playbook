...
### Phase 1: 🔴 必补 — 专业 PM 的核心能力

| 模块 | 文档 | 核心内容 |
|------|------|---------|
| **08 用户研究** | user-research-methods.md | AI 产品的用户访谈、调研、可用性测试（和传统产品的差异） |
| | demand-validation.md | 验证用户对 AI 功能的真实需求（勾选测试、Concierge MVP、假门测试） |
...
| **11 开发流程** | product-lifecycle-guide.md | AI 产品从 0 到 1 的完整时间线 + 每个阶段 PM 做什么 |
| | prompt-management.md | Prompt 版本控制、测试、Staging→Prod 流程 |
| | pm-mle-collaboration.md | AI PM 与 ML Engineer / DS 的分工协作模型 |
| | model-iteration-playbook.md | 模型升级的灰度策略、对用户感知的影响评估、回滚机制 |
